...
?>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <hr>
        <a class="btn btn-primary" href="<?php echo base_url('Hasilpilih/export'); ?>"><i class="fa fa-print">
        </i> Cetak</a>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        ...
                                        <h1><br><?php echo $totalsuara; ?> Suara</h1>
                                         <button type="button" class="btn btn-success"><h3><?php $persen = ($totalsuara / $nototal) * 100; echo number_format($persen, 2); ?> % Suara</h3></button>
                                        <br><br>
                                    </center>
                                    </li>
                                </ul>
