...
?>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">  
            <div class="top-left">
                <div class="navbar-header"> 
                    <a class="navbar-brand" href=""><img src="images/evot.png" alt="Logo"></a> 
        ...
        <div class="col"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahdata" ><i class="fa fa-plus-circle"></i>&nbsp; Tambah</button> <a href="<?php echo base_url('datapem/export') ?>" class="btn btn-primary" ><i class="fa fa-print"></i>&nbsp; Export</a></div>
    	</div>
        <hr>
