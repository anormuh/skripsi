...
<body>
        ...
        <header id="header" class="header">  
            <div class="top-left">
                <div class="navbar-header"> 
                    <a class="navbar-brand" href=""><img src="<?=base_url()?>images/evot.png" alt="Logo"></a>
                </div> 
            </div>
  ...
  <div class="content pb-0">
        ...
        <h1><i class="fa fa-bar-chart-o"> </i>Quick Count</h1>
        <hr><br><br><br>
                            ...
                            <section class="card">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        ...
                                        <center>
                                        <div>
                                           <button type="button" class="btn btn-success"><h1><?php $persen = ($totalsuara / $nototal) * 100; echo number_format($persen, 2); ?> % Suara</h1></button>
                                        </div>
                                    </center>
                                    </li>
                                </ul>
